...
class Compound
  Hall = Data.define(:key, :cx, :cy, :w, :h, :han) do
    def left = cx - w / 2.0
    def top = cy - h / 2.0
  end
  ...
  HALLS = [
    ...
    Hall.new(key: :maitreya, cx: 52.1, cy: 33.2, w: 14.3, h: 15.6, han: "彌勒堂"), # 미륵당 — 날들
    ...
    Hall.new(key: :courtyard, cx: 52.1, cy: 55.7, w: 28.6, h: 21.5, han: nil),     # 마당 — 아래로, 비움 선언
